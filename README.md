# CKEditor 5 editor customized for Venue Edit Client generated with the online builder

This repository presents a CKEditor 5 editor build generated by the [Online builder tool](https://ckeditor.com/ckeditor-5/online-builder)

## Features
This customized version of CKEditor supports following features.
* Bold
* Italic
* Underline
* Bullets
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `9tum93atavej-ea51ev4u2tan`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
